...
#Role of Osmotic Strength in honey and glucose 
#  Ahmad Abdel-Azim 
#  Salma Abdel-Azim
#  Mentor: Gamal Abdel-Azim 
...
honeyGlu.d5 <- read.csv("C:/Users/Ahmad Abdel-Azim/Documents/Research/Osmolality Exp/Version 1 May 30/honeyGlucosetoCd5.csv", header = T)
...
#predictive model for osm (11/22/18: no longer used due to actual meausre of all concentration osm)
OsmVsMgperml <- read.csv("OsmVsMgpermlData.csv", header = T)
...
#==============================================================
#Day 1-5 (but with control on all 13 days and no L180)
#==============================================================
alldata <- read.csv("C:/Users/Ahmad Abdel-Azim/Documents/Research/Honey/Exp III/R codes/RawData.csv")
